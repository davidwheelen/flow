...
const noiseSteps = 8;
const xOff = 0.0003; // Changed from 0.00073 to make pattern ~4x larger (was 0.00125 originally)
const yOff = 0.0003; // Changed from 0.00073 to make pattern ~4x larger (was 0.00125 originally)
const zOff = 0.0005;
