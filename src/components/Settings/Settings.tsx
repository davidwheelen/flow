...
import { Settings as SettingsIcon, X, Eye, EyeOff, Lock, CheckCircle, AlertCircle, Loader2, Shield } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(0, 0, 0, 0.7)' }}>
      ...
      >
        ...
        {/* Footer - Only show for InControl2 manual tab */}
        {activeMainTab === 'incontrol2' && activeTab === 'manual' && (
