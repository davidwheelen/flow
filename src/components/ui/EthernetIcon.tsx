...
export const EthernetIcon: React.FC<EthernetIconProps> = ({ 
  ...
  // Use green for connected, gray for disconnected
  const fillColor = isConnected ? '#22c55e' : '#6b7280';
